...
% % 
tmpInstr = sprintf('当你看到屏幕中心出现的彩色字的时候，请根据字的颜色选择对应的按键。\n如果字的颜色为绿色，请按J键；\n如果字的颜色为红色，请按K键；\n如果字的颜色为蓝色，请按L键。');
hText_Content = uicontrol('style','text', 'String',tmpInstr, 'fontname','Microsoft Yahei', 'position',[301 301 1200 500], 'fontsize',36, 'backgroundcolor',bkgColor, 'HorizontalAlign','left', 'ForegroundColor',fontColor);
% 
tmpGo = '请按空格开始正式实验';
...
jpgFileName_instruction = 'Instruction_Start_Color.jpg';
