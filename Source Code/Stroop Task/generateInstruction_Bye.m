...
% create a uicontrol
hText_Kaishi = uicontrol('Style','Text', 'String','          实验结束，请按空格键退出', 'Fontname','Microsoft Yahei', 'Position',[261 450 1200 100], 'Fontsize',40, 'Backgroundcolor',bkgColor, 'ForegroundColor',fontColor);
